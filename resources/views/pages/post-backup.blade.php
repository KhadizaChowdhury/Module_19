    ...
    <div class="container mx-auto flex flex-wrap py-6">
        ...
        <section class="w-full md:w-3/3 flex flex-col items-center px-3">
            ...
            <div class="w-full flex pt-6">
                @if ($previousPost)
                <a href="{{ route('posts.postDetails', $previousPost->id) }}" class="w-1/2 bg-white shadow hover:shadow-md text-left p-6">
                ...
                @if ($nextPost)
                <a href="{{ route('posts.postDetails', $nextPost->id) }}" class="w-1/2 bg-white shadow hover:shadow-md text-right p-6">
